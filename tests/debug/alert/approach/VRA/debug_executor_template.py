"""
A command-line tool for debugging the VRA (Volume-Reversal-Anchor) alert logic.

This script is designed to be run from the project root. It allows for testing the VRA
approach on a specific symbol and date range, with options to save the data and generate
...
def run_debug_analysis(symbol, start_time_str, end_time_str, save_to_file, generate_chart):
    """
    Sets up the environment and runs the debug analysis for the VRA approach.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Debug script for the VRA (Volume-Reversal-Anchor) approach.")
