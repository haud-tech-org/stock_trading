"""
A command-line tool for debugging the MOMENTUM_EXHAUSTION alert logic by calling the main executor.

Usage:
    python3 tests/debug/alert/approach/MOMENTUM_EXHAUSTION/debug_executor.py \\
...
if __name__ == "__main__":
    ...
    """
    parser = argparse.ArgumentParser(description="Debug the MOMENTUM_EXHAUSTION logic by calling the main executor.")
