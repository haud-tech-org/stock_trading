class Approach:
    ...
    DOJI_ANCHOR_SIGNAL_CANDLE = "DOJI_ANCHOR_SIGNAL_CANDLE"
    PRICE_MOVEMENT = "PRICE_MOVEMENT"  # Price level crossing alerts
    LARGE_CANDLE = "LARGE_CANDLE"  # Candle body (announce)
    LARGE_VOLUME_CANDLE = "LARGE_VOLUME_CANDLE"  # Candle volume (announce)
