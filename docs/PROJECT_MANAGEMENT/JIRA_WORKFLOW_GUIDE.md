...
2. Implement the feature following the project architecture:
   ...
   - Code quality → follow [`CODE_QUALITY_STANDARDS.md`](../ARCHITECTURE/CODE_QUALITY_STANDARDS.md)
...
| [`CODE_QUALITY_STANDARDS.md`](../ARCHITECTURE/CODE_QUALITY_STANDARDS.md) | Code quality rules developers must follow |
| [`STANDARD_TESTING_CONVENTION.md`](../STANDARDIZATIONS/STANDARD_TESTING_CONVENTION.md) | Testing conventions for this project |
| [`DEVELOPER_ONBOARDING_GUIDE.md`](../ARCHITECTURE/DEVELOPER_ONBOARDING_GUIDE.md) | Architecture learning path for new developers |
