...
**Read in order**:
4. **`docs/REFERENCES/IMPLEMENTATION/CREATING_NEW_APPROACH.md`**
   - Step-by-step guide for new approaches
   - Templates and boilerplate
   - Best practices
   - Duration: 30 minutes

5. **`docs/REFERENCES/IMPLEMENTATION/IMPLEMENTATION_BEST_PRACTICES.md`**
   - Common pitfalls
   - Testing strategies
...
→ See `docs/REFERENCES/IMPLEMENTATION/CREATING_NEW_APPROACH.md`
...
- Implementation: `docs/REFERENCES/IMPLEMENTATION/`
