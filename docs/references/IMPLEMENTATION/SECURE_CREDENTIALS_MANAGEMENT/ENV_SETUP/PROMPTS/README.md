...
- Google Cloud? Already done - see docs/REFERENCES/IMPLEMENTATION/SECURE_CREDENTIALS_MANAGEMENT/ENV_SETUP/GOOGLE_CLOUD/
...
```
docs/REFERENCES/IMPLEMENTATION/SECURE_CREDENTIALS_MANAGEMENT/ENV_SETUP/AZURE/
  ├── README.md
...
Or for AWS:
```
docs/REFERENCES/IMPLEMENTATION/SECURE_CREDENTIALS_MANAGEMENT/ENV_SETUP/AWS/
  ├── README.md
  ├── 01_DEPLOYMENT_SETUP.md
  ├── 02_DEPLOYMENT_EXECUTION_&_VERIFICATION.md
  └── 03_OPERATIONS_&_REFERENCE.md
...
```
docs/REFERENCES/IMPLEMENTATION/SECURE_CREDENTIALS_MANAGEMENT/ENV_SETUP/
...
4. Save to `docs/REFERENCES/IMPLEMENTATION/SECURE_CREDENTIALS_MANAGEMENT/ENV_SETUP/AZURE/`
5. Test and adjust
...
2. Copy the prompt
3. Run with AI assistant
4. Save to `docs/REFERENCES/IMPLEMENTATION/SECURE_CREDENTIALS_MANAGEMENT/ENV_SETUP/AWS/`
5. Test and adjust
